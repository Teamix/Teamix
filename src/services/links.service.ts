...
export class LinksService {
  ...
  public numOfLinks = [
    ...
    { packName: 'teamixSelectedVol7', img: './assets/selectedVols/teamixSelectedVol7.jpeg', playlist: this.itemsPlaylist.getItemsPlaylist().teamixSelectedVol7, genre: 'selected', link: '', price: 24.99, value: '1' },
