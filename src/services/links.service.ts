...
export class LinksService {
  ...
  public numOfLinks = [
    { packName: 'teamixVol20', img: './assets/teamixVols/teamixVol20.jpg', playlist: this.itemsPlaylist.getItemsPlaylist().teamixVol20, genre: 'issue', link: '', price: 69.99, value: '2' },
    ...
    { packName: 'teamixSelectedVol5', img: './assets/selectedVols/teamixSelectedVol5.jpeg', playlist: this.itemsPlaylist.getItemsPlaylist().teamixSelectedVol5, genre: 'selected', link: '', price: 24.99, value: '1' },
    { packName: 'teamixSelectedVol4', img: './assets/selectedVols/teamixSelectedVol4.jpg', playlist: this.itemsPlaylist.getItemsPlaylist().teamixSelectedVol4, genre: 'selected', link: '', price: 24.99, value: '4' },
    ...
    { packName: 'teamixLatinVol6', img: './assets/latinVols/teamixLatinVol6.jpg', playlist: this.itemsPlaylist.getItemsPlaylist().teamixLatinVol6, genre: 'latin', link: 'https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=6J2VD5577LDTY&source=url', price: 29.99, value: '3' },
    ...
    { packName: 'teamixThrowbackVol7', img: './assets/throwbackVols/teamixThrowbackVol7.jpg', playlist: this.itemsPlaylist.getItemsPlaylist().teamixThrowbackVol7, genre: 'throwback', link: 'https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=PVKJPPKV7VTWA&source=url', price: 24.99, value: '5' },
